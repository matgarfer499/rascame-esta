...
export const MEMORY_ROUNDS = 3;
export const MEMORY_INITIAL_SEQUENCE_LENGTH = 3;
export const MEMORY_SEQUENCE_INCREMENT = 1;
export const MEMORY_FLASH_DURATION_MS = 800;
